...
void Application::Display(void)
{
	...
	case 2:
		...
		m_pCamera->SetHorizontalPlanes(vector2(-10, 10));
		break;
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetFOV(400);
		m_pCamera->SetPositionTargetAndUpward(vector3(20, 0, -5), vector3(0, 0, 1), vector3(0, 0, 1));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0, 0, -16), vector3(0, 0, 1), vector3(0, 1, 0));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0, 0, -10), vector3(0, 0, 1), vector3(0, 1, 0));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0, 0, -15), vector3(0, 0, -10), vector3(0, 1, 0));
